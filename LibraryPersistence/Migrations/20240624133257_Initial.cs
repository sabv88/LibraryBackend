        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Returned = table.Column<bool>(type: "boolean", nullable: true),
                    TakingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 6, 24, 13, 32, 56, 978, DateTimeKind.Utc).AddTicks(4055)),
                    ReturnTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 6, 25, 13, 32, 56, 978, DateTimeKind.Utc).AddTicks(4688))
                },
                constraints: table =>
                {
